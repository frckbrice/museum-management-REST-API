...
export class GalleryService extends BaseService {
    ...
    async getAllGalleryItems(category?: string, limit: number = 20, offset: number = 0): Promise<{
        data: GalleryItem[];
        total: number;
        hasMore: boolean;
    }> {
    ...
    async getGalleryItemsByCategory(category: string, limit: number = 20, offset: number = 0): Promise<{
        data: GalleryItem[];
        total: number;
        hasMore: boolean;
    }> {
