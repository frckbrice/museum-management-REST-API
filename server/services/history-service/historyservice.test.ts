...
describe("HistoryService", () => {
  ...
  describe("getHistoryContentById", () => {
    it("should return history content when found", async () => {
      ...
      const result = await historyService.getHistoryContentById(
    ...
    it("should throw ValidationError for invalid ID", async () => {
      ...
      await expect(historyService.getHistoryContentById("invalid")).rejects.toThrow(
        ValidationError
      );
    });
  });
  ...
  describe("createHistoryContent", () => {
    ...
    it("should append timestamp to slug if duplicate exists", async () => {
      ...
      mockDb.query.historyContent.findFirst
  ...
  describe("updateHistoryContent", () => {
    ...
    it("should throw NotFoundError for non-existent content", async () => {
      mockDb.query.historyContent.findFirst.mockResolvedValue(null);
      await expect(historyService.updateHistoryContent(validId, validUpdate)).rejects.toThrow(
        NotFoundError
      );
    });

    it("should throw ValidationError for empty update data", async () => {
      await expect(historyService.updateHistoryContent(validId, {})).rejects.toThrow(
        ValidationError
      );
    });
    ...
    it("should throw ValidationError for invalid ID", async () => {
      ...
      await expect(historyService.updateHistoryContent(invalidId, validUpdate)).rejects.toThrow(
        ValidationError
      );
  ...
  describe("deleteHistoryContent", () => {
    ...
    it("should throw NotFoundError for non-existent content", async () => {
      ...
      await expect(historyService.deleteHistoryContent(validId)).rejects.toThrow(NotFoundError);
