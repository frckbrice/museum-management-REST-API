...
export class HistoryService extends BaseService {
  ...
  async createHistoryContent(data: HistoryContent): Promise<HistoryContent> {
    ...
    const sanitizedData = {
      ...
      slug: data.slug
        ? sanitizeString(data.slug.toLowerCase())
  ...
  async updateHistoryContent(id: string, data: Partial<HistoryContent>): Promise<HistoryContent> {
    try {
      ...
      return this.withErrorHandling(
        ...
        { preserveErrors: [ValidationError, NotFoundError] }
    ...
    try {
      ...
      return this.withErrorHandling(
        async () => {
          ...
          const result = await this.db.delete(historyContent).where(eq(historyContent.id, id));
