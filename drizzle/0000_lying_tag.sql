...
CREATE TYPE "public"."user_status" AS ENUM('visitor', 'attendant', 'admin');--> statement-breakpoint
...
CREATE TABLE IF NOT EXISTS "groups" (
	...
	"description" text NOT NULL,
	"slug" text NOT NULL,
	"is_attendant_only" boolean DEFAULT false,
...
CREATE TABLE IF NOT EXISTS "history_content" (
	...
	CONSTRAINT "history_content_slug_unique" UNIQUE("slug")
);
--> statement-breakpoint
...
CREATE TABLE IF NOT EXISTS "users" (
	...
	"email" text NOT NULL,
	"full_name" text NOT NULL,
	"role" "user_status" DEFAULT 'visitor' NOT NULL,
	"profile_image" text,
	"bio" text,
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	"updated_at" timestamp with time zone DEFAULT now() NOT NULL,
...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "history_content" ADD CONSTRAINT "history_content_author_id_users_id_fk" FOREIGN KEY ("author_id") REFERENCES "public"."users"("id") ON DELETE set null ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
