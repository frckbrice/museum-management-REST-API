import { z } from "zod";
// Use namespace import so compiled CJS works (dotenv has no .default in CommonJS)
import * as dotenv from "dotenv";

const dotenvModule = dotenv as { config?: () => void };
...
const envSchema = z
  .object({
    ...
    API_PROD_URL: z.string().url("API_PROD_URL must be a valid URL").optional(),

    // Optional comma-separated list of extra CORS origins
